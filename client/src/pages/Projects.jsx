      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 mt-20">
        ...
        <section className="mb-32 relative">
          ...
          <ScrollReveal className="mb-12 text-left relative z-10">
            <span className="section-label">// section.featured</span>
                ...
                <GlowCard className="border border-hairline-strong bg-canvas rounded-none p-8 flex flex-col md:flex-row gap-8 items-stretch relative card-brackets">
                  ...
                  <div className={`w-full md:w-3/5 flex flex-col justify-between text-left ${i % 2 === 1 ? 'md:order-1' : ''}`}>
                    ...
                    <div className="flex flex-wrap gap-1.5 items-center justify-between border-t border-hairline pt-4">
                      ...
                      >
                        inspect_source() <span className="arrow">&rarr;</span>
                      </a>
                    </div>
                  </div>
                </GlowCard>
        ...
        <section className="relative">
          ...
          <ScrollReveal className="mb-12 text-left z-10 relative">
            <span className="section-label">// section.more</span>
            <h2 className="text-3xl font-bold tracking-tight text-ink mb-4">
              More Projects
            </h2>
          </ScrollReveal>
          ...
          >
            {archive.map((proj, i) => (
              <motion.div key={i} variants={fadeUp}>
                <GlowCard className="article-card min-h-[360px] p-6">
                  <div>
                    <div className="flex justify-between items-start text-[10px] font-mono mb-4">
                      <span className="text-accent-signal bg-accent-signal/5 px-2 py-0.5 border border-hairline-strong font-bold">
                        {proj.year}
                      </span>
                  ...
                  <div className="mt-auto pt-4 border-t border-hairline flex flex-col gap-4">
                    <div className="flex flex-wrap gap-1">
                      {proj.tags.map((tag, idx) => (
                        <span
                          key={idx}
                          className="text-[8px] text-mute bg-surface-soft px-1.5 py-0.5 border border-hairline"
                        >
                          {tag}
                        </span>
                      ))}
